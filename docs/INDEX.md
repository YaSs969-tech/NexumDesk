...
Use this file as the main entry point for NexumDesk documentation.
...
| [TROUBLESHOOTING.md](TROUBLESHOOTING.md) | Known issues and practical fixes. |
| [REQUIREMENTS_CLOSURE.md](REQUIREMENTS_CLOSURE.md) | Mapping implementation to project requirements. |
